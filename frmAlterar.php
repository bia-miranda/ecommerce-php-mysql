...
$consultaCat = $con->query("SELECT id_categoria, ds_categoria FROM tbl_categoria WHERE id_categoria='$id2' UNION SELECT id_categoria, ds_categoria FROM tbl_categoria WHERE id_categoria != '$id2'");
?>
